                ...
                Column(
                    ...
                    if (dataRetentionEnabled) {
                        ...
                        Column(
                            ...
                            Text(
                                text = stringResource(R.string.data_retention_days),
                                style = MaterialTheme.typography.bodyLarge
                            )
                            Spacer(modifier = Modifier.height(4.dp))
                            Text(
                                text = stringResource(R.string.data_retention_days_description),
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Spacer(modifier = Modifier.height(8.dp))

                            fun isValidDataRetentionDays(days: Int?): Boolean {
                            ...
                            OutlinedTextField(
                                ...
                                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                                singleLine = true,
                                isError = !isValidDataRetentionDays(dataRetentionDaysText.toIntOrNull())
                            )
