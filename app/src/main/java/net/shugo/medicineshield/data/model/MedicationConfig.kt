...
data class MedicationConfig(
    ...
    val medicationEndDate: String = net.shugo.medicineshield.utils.DateUtils.MAX_DATE,  // 実際の服用終了日（yyyy-MM-dd形式、デフォルト=最大値）
    ...
    val validTo: String = net.shugo.medicineshield.utils.DateUtils.MAX_DATE,  // この設定レコードが無効になった日付（yyyy-MM-dd形式、デフォルト=最大値）
