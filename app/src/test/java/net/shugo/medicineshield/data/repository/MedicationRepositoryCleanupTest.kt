...
class MedicationRepositoryCleanupTest {
    ...
    fun `cleanupOldData should NOT delete medications with intake records even if ended before retention period`() = runTest {
        ...
        // med2: ended 50 days ago, HAS old intake records - should be deleted
        ...
        createIntake(med2, -50)  // Another old intake record
        ...
        createIntake(med3, -49)  // Recent intake record (within retention period)
        ...
        // When: Clean up data with 49 days retention
        repository.cleanupOldData(retentionDays = 49)
        ...
        val deletedMed2 = database.medicationDao().getMedicationById(med2)
        assertNull("Medication ended 50 days ago WITH old intake records should be deleted", deletedMed2)
